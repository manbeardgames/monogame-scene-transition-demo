...
namespace SceneTransitionDemo.Transitions
{
    ...
    ///     then the even tiles
    /// </summary>
    public class EvenOddTransition : Transition
    {
        ...
        /// </param>
        public EvenOddTransition(GameBase game, int tileSize, TimeSpan transitionTime, TransitionKind kind)
        ...
        public override void Start(RenderTarget2D sourceTexture)
        {
            ...
            _columns = SourceTexture.Width / _tileSize;
            _rows = SourceTexture.Height / _tileSize;
        }
